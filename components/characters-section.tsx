            ...
            <div className="relative p-8 border border-border rounded-lg bg-card">
              ...
              <div className="aspect-[3/4] mb-6 border border-dashed border-primary/40 rounded-lg bg-secondary/20 flex items-center justify-center">
                <div className="text-center">
                  <span className="text-muted-foreground text-sm block">[{t.illustrationOf} {t.lumen}]</span>
                  <span className="text-xs text-muted-foreground/60 mt-2 block">{t.characterOfLight}</span>
                </div>
              </div>
          ...
          <div className="group relative">
            ...
            <div className="relative p-8 border border-border rounded-lg bg-card">
              ...
              <div className="aspect-[3/4] mb-6 border border-dashed border-muted-foreground/40 rounded-lg bg-secondary/30 flex items-center justify-center">
                <div className="text-center">
                  <span className="text-muted-foreground text-sm block">[{t.illustrationOf} {t.vyre}]</span>
                  <span className="text-xs text-muted-foreground/60 mt-2 block">{t.characterOfShadow}</span>
                </div>
              </div>
